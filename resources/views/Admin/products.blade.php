                                    ...
                                    @foreach($products as $product)
                                        <tr>
                                            ...
                                            <td class="tm-product-name">
                                                <a href="{{ route('edit', ['id' => $product->id]) }}" style="text-decoration: none; color: inherit;">
                                                    {{ $product->name }}
                                                </a>
                                            </td>
                                            <td>{{ $product->price }}</td>
                                            ...
                                            <td>
                                                <a href="{{ route('products.delete.single', ['id' => $product->id]) }}" class="tm-product-delete-link"
                                                ...
                                                <form id="delete-form-{{ $product->id }}" action="{{ route('products.delete.single', ['id' => $product->id]) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>

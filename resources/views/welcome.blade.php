            ...
            <div class="row">
                <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto"> 
                    <div class="block1 hov-img-zoom pos-relative m-b-30"> 
                        <img src="{{ asset('assets/img/Project-images/Ram/Ram.jpg') }}" alt="IMG-BENNER" style="width: 100%;max-width: 100%;height: auto;margin-left: 5px;"> 
                        <div class="block1-wrapbtn w-size2">
                            <a href="{{ route('shop', ['category' => 'RAM']) }}" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                Ram
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        <img src="{{ asset('assets/img/Project-images/Motherboard/Motherboard.png') }}" alt="IMG-BENNER" style="width: 100%;max-width: 100%;height: auto;margin-left: 2px;">
                        <div class="block1-wrapbtn w-size2">
                            <a href="{{ route('shop', ['category' => 'Motherboard']) }}" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                Motherboard
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        <img src="{{ asset('assets/img/Project-images/GPU/GPU.jpg') }}" alt="IMG-BENNER"
                            style="width: 100%;max-width: 100%;height: auto;margin-left: -3px;">
                        <div class="block1-wrapbtn w-size2">
                            <a href="{{ route('shop', ['category' => 'GPU']) }}"
                    ...
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        <img src="{{ asset('assets/img/Project-images/PowerSupply/Powersupply.png') }}" alt="IMG-BENNER"
                            style="width: 100%;max-width: 100%;height: auto;margin-left: -9px; margin-top: 51px;">
                        <div class="block1-wrapbtn w-size2">
                            <a href="{{ route('shop', ['category' => 'PowerSupply']) }}" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                Power Supply
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        <img src="{{ asset('assets/img/Project-images/CPU/CPU.jpg') }}" alt="IMG-BANNER" style="width: 100%; max-width: 100%; height: auto; margin-left: -1px;">
                        <div class="block1-wrapbtn w-size2">
                            <a href="{{ route('shop', ['category' => 'CPU']) }}" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                CPU
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="block2 wrap-pic-w pos-relative m-b-30">
                        <img src="{{ asset('assets/img/bg-01.png') }}" alt="IMG"
                        ...
                        <div class="properties pb-30">
                            <div class="properties-card">
                                <div class="properties-img">
                                    <a href="{{ route('products', ['id' => $item->id]) }}"><img
                                            src="{{ asset($item->imgpath) }}" alt></a>
                                    <div class="socal_icon">
                                        ...
                                        <a href="{{ route('products', ['id' => $item->id]) }}"><i class="ti-zoom-in"></i></a>
                                    </div>
                                </div>

                                <div class="properties-caption properties-caption2">
                                    <h3><a href="{{ route('products', ['id' => $item->id]) }}">{{ $item->name }}</a>
                                    </h3>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
                                    <div class="block2">
                                        <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
                                            <img src="{{ asset($item->imgpath) }}" alt="IMG-PRODUCT"
                ...
                <div class="row clearfix">
                    ...
                    <div class="image-column col-lg-6">
                        <div class="image">
                            ...
                            <img src="{{ asset('assets/img/Project-images/Case/Pc Gaming.png') }}" alt="" style="max-width: 80%; margin-left: 83px; margin-top: -61px;">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-latest-news">
                            ...
                            <div class="news-text-box">
                                ...
                                <a href="{{ route('news') }}" class="read-more-btn">read more <i class="fas fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                    ...
                    <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
                        <div class="single-latest-news">
                            ...
                            <div class="news-text-box">
                                <h3><a href="{{ route('news') }}">Four Reasons to Avoid Best Buy's Member Deals Days</a></h3>
                                <p class="blog-meta">
                                    <span class="author"><i class="fas fa-user"></i> Admin</span>
                                    <span class="date"><i class="fas fa-calendar"></i> 27 December, 2023</span>
                                </p>
